            ...
            switch ($step) {
              default: ?>
                ...
                <div style='text-align: right;'>
                  ...
                  <?php }else{ ?>
                  <a href="bundle_install.php?step=0" class="button is-link">Next</a>
                  <?php } ?>
                </div><?php
                break;
              case "0": ?>
                ...
                <?php
                  ...
                  if(!empty($_POST['license'])&&!empty($_POST['client'])){
                    ...
                    if($activate_response['status'] != true){ ?>
                      ...
                      <form action="bundle_install.php?step=1" method="POST">
              ...
              case "1": ?>
                ...
                <?php
                  if($_POST && isset($_POST["lcscs"])){
                    ...
                    ?>
                    <form action="bundle_install.php?step=2" method="POST">
